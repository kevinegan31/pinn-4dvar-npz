...
NEPOCH_ADAM = int(os.getenv('NEPOCH_ADAM', '1500')) #100 #int(os.getenv('NEPOCH_ADAM', '100'))
...
NUM_RSAMPLES = int(os.getenv('NUM_RSAMPLES', '50')) #15 #int(os.getenv('NUM_RSAMPLES', '15'))
